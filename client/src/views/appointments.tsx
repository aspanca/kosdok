    ...
    return (
      <div className="min-h-screen bg-[#f8f8f8] flex items-center justify-center p-4">
        <div className="bg-white border border-[#dedede] p-8 max-w-md w-full text-center">
          ...
          <Link href={{ pathname: "/signin", query: { mode: "login" } }} className="inline-flex items-center justify-center h-12 px-8 bg-primary hover:bg-primary/90 text-white text-[14px] font-[600]">
            Kyçu
          </Link>
        </div>
      </div>
              ...
              <div className="divide-y divide-[#dedede]">
                {isLoading ? (
                  ...
                  <div className="p-12 text-center">
                    ...
                    {activeTab === "upcoming" && (
                      <Link href="/" className="inline-flex items-center justify-center mt-4 h-10 px-6 bg-primary hover:bg-primary/90 text-white text-[13px] font-[600]">
                        Gjej mjek
                      </Link>
                    )}
                  </div>
                              ...
                              <Link
                                href={
                                  appointment.providerType === "doctor"
                                    ? `/doctor/${String(appointment.providerId)}`
                                    : `/hospital/${String(appointment.providerId)}`
                                }
