              ...
              <div className="divide-y divide-[#dedede]">
                {isLoading ? (
                  ...
                  <div className="p-12 text-center">
                    ...
                    <Link href="/results" className="inline-flex items-center justify-center mt-4 h-10 px-6 bg-primary hover:bg-primary/90 text-white text-[13px] font-[600]">
                      Gjej mjek
                    </Link>
                  </div>
                ) : (
                              ...
                              <Link
                                href={
                                  review.providerType === "doctor"
                                    ? `/doctor/${review.providerId}`
                                    : `/hospital/${review.providerId}`
                                }
